...
// ============================================================
// /components/lab/DiagramViewer.tsx
// SVG-based labelled diagrams for all 15 experiments.
// Each diagram is keyed by DiagramConfig.svgKey.
// ============================================================
...
// ─────────────────────────────────────────────────────────────
// Individual SVG drawings — one per svgKey
// ─────────────────────────────────────────────────────────────
...
function ConcaveMirrorSVG() {
  return (
    <svg viewBox="0 0 420 280" className="w-full h-full">
      ...
      <line x1="380" y1="100" x2="65" y2="100" stroke="#f39c12" strokeWidth="1.8" markerEnd="url(#arr)" />
      ...
      {/* Reflected rays converging at F */}
...
function BarMagnetFieldSVG() {
  return (
    <svg viewBox="0 0 420 280" className="w-full h-full">
      ...
      {/* Field lines — left loops */}
      <path d="M130,140 Q80,80 210,60 Q290,50 290,140" fill="none" stroke="#e67e22" strokeWidth="1.5" strokeDasharray="none" opacity="0.7" />
...
// ─────────────────────────────────────────────────────────────
// DiagramViewer — public component
// ─────────────────────────────────────────────────────────────
...
export default function DiagramViewer({ diagram }: DiagramViewerProps) {
  ...
  if (!SVGComponent) {
    return (
      <div className="flex items-center justify-center h-48 text-sm text-gray-400 border border-dashed border-gray-200 rounded-lg">
        Diagram not available for this experiment.
      </div>
    );
  }
